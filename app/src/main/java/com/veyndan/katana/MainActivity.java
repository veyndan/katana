...
public class MainActivity extends BaseActivity {
    ...
    private List<Post> init() {
        ...
        posts.add(new Post(this, profileUrl, "Veyndan Stuart", Post.NONE, "1 Apr at 15:17", imageUrl));
        ...
        imageUrl = profileUrl;
        posts.add(new Post(this, profileUrl, "Roksolana Zasiadko", Post.UPDATE_PROFILE_PICTURE, "28 Mar at 12:54", imageUrl));
        return posts;
    }
}
